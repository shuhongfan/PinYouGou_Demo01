                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationList as spec>
                            ...
                            <#list spec.attributeValue as item>
                                <dd><a ng-click="selectSpecification('${spec.attributeName}','${item}')"
                                            class="{{isSelect('${spec.attributeName}','${item}')?'selected':''}}" href="javascript:;">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
                            </#list>
                        </dl>
                        </#list>
